...
# with command line options: REDIGI --step DIGI,L1,DIGI2RAW,HLT:GRun,RAW2DIGI,L1Reco,RECO --conditions auto:startup --pileup mix_E7TeV_Fall2011_Reprocess_50ns_PoissonOOTPU_cfi --datamix NODATAMIXER --eventcontent AODSIM --datatier AODSIM --filein file:TT_powheg_GEN-SIM.root --fileout TT_powheg_AODSIM.root --python_filename TT_powheg_AODSIM_cfg.py --no_exec -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:TT_powheg_GEN-SIM.root')
)
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TT_powheg_AODSIM.root'),
